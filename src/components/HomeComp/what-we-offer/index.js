...
export default () => {
    ...
    return (
        <div className="relative max-lg:border-2 border-black pt-6 px-4 bg-gradient-to-br from-gray-200 via-white to-gray-200  flex justify-center items-center rounded-md " style={{
            // background: "linear-gradient(152.92deg, rgba(132, 252, 192, 0.2) 4.54%, rgba(121, 249, 232, 0.17) 34.2%, rgba(132, 252, 192, 0.1) 77.55%)",
        }}>
            <section className="leading-relaxed max-w-screen mt-12 mx-auto px-4 md:px-8 z-20">
